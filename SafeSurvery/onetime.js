...
var userinfo = function() {
  ...
  console.log(questionare.question.length);
	...
	if (questionare.question.length > calc) {
		...
		$('#formbox').append("<div id='userquest'><p>" + questionare.question[calc] + "</p></div>");
		for (var j = 0; j < questionare.alt[calc].length; j++) {

			$('#formbox').append('<input class="useranswers" type="radio" name="userchoice" value="' + calc2 + '">' + questionare.alt[calc][j]);
			calc2 = calc2 + 1;
		}
